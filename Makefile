...
premain-app:
	$(GOBUILD) -o ./premain premain-app/*

premain-vault:
	$(GOBUILD) -o ./vault/premain-vault premain-vault/*
...
.PHONY: build clean fmt start enable premain premain-app premain-vault enclave
